    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        <TouchableOpacity style={styles.monthSelector}>
          <Text style={styles.headerTitle}>January 2026</Text>
            ...
            {expenseData.map((item, index) => (
              <View key={index} style={styles.expenseCard}>
                <View style={styles.expenseCardTop}>
                  ...
                  <View style={[styles.remainingBadge, { backgroundColor: (item.planned - item.spent) > 0 ? 'rgba(25, 230, 94, 0.2)' : 'rgba(255, 255, 255, 0.05)' }]}>
                    <Text style={[styles.remainingText, { color: (item.planned - item.spent) > 0 ? '#19e65e' : '#6b7280'}]}>
                ...
                <View style={styles.expenseCardBottom}>
                  ...
                  <View style={styles.amountContainer}>
                    ...
                    <TextInput style={styles.spentInput} defaultValue={`$${item.spent}`} />
                  </View>
                </View>
              </View>
            ))}
...
const styles = StyleSheet.create({
  ...
  closeButton: { backgroundColor: '#19e65e', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 16, borderRadius: 12, gap: 8 },
